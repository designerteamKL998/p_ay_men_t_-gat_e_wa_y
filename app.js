...
function submitDeposit(){let btn=$('#submitBtn');if(btn.disabled)return;btn.disabled=true;btn.textContent='Creating secure payment order…';setTimeout(()=>{btn.disabled=false;openModal()},700)}
